...
function findItinerary(tickets) {
    ...
    function dfs(currentAirport) {
        ...
        for (let i = 0; i < destinations.length; i++) {
            ...
            path.pop();
            //The line destinations.splice(i, 0, nextAirport);
            //  restores the ticket (airport) that was removed 
            // earlier if the current 
            // recursive path is invalid during backtracking in a DFS algorithm.
