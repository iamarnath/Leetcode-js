...
function find(board, i, j, word, idx) {
   //Base case: if idx equals or exceeds the word length,
   //  it means all characters have been successfully matched.
...
//  avoiding cycles.
    ...
    */
    ...
    //Restores the original character at (i, j) to allow 
    // other paths to use this cell.

    //Returns false indicating the word cannot be formed
    //  starting from this cell and index.
    board[i][j] = temp;
    return false;
}
