...
*/
/*
i = 1: Compare [1,4] with lastInterval = [1,2]
curr_start = 1, curr_end = 4, last_end = 2
Since curr_start < last_end and curr_end >= last_end, increment count (removing [1,4]).
So, count = 1
lastInterval remains [1,2]

i = 2: Compare [2,4] with lastInterval = [1,2]
curr_start = 2, curr_end = 4, last_end = 2
Since curr_start >= last_end, no overlap. So, update lastInterval = [2,4].
