...
Steps
If either string is exhausted (i.e., one of the indices is -1),
 the cost is simply the length of the other string 
 (since we’d need to insert or delete all characters).
If word1[i] and word2[j] match, no operation is needed 
for these characters, so we move both pointers to the previous characters.
